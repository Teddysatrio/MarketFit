...
server <- function(input, output) {
  ...
  rv$case <- eventReactive(input$Check,{
    ...
    Market_fit <- function(SF){
      #look_for <- c(name)
      #a <- tail(SF[SF$package_name_detail %in% look_for, ],1)
      #print(a)
      a<- tail(SF,1)
      if(a$package_price <=20000 & a$category_business == "Validity + quota"){
        b = OC_1
      }else if(a$package_price <=20000 & a$category_business =="Roaming"){
        b = OC_2
      }else if(a$package_price <=20000 & a$category_business =="VAS"){
        b = OC_3
      }else if(a$package_price <=20000 & a$category_business =="Unlimited"){
        b = OC_4
      }else if(a$package_price <=20000 & a$category_business =="Voice"){
        b = OC_5
      }else if(a$package_price <=20000 & a$category_business =="Sms"){
        b = OC_6
      }else if(a$package_price <=20000 & a$category_business =="Bonus/promotion"){
        b = OC_49
      }else if(a$package_price >20000 & a$package_price <=50000 & a$category_business =="Validity + quota"){
        b = OC_7
      }else if(a$package_price >20000 & a$package_price <=50000 & a$category_business =="Roaming"){
        b = OC_8
      }else if(a$package_price >20000 & a$package_price <=50000 & a$category_business =="VAS"){
        b = OC_9
      }else if(a$package_price >20000 & a$package_price <=50000 & a$category_business =="Unlimited"){
        b = OC_10
      }else if(a$package_price >20000 & a$package_price <=50000 & a$category_business =="Voice"){
        b = OC_11
      }else if(a$package_price >20000 & a$package_price <=50000 & a$category_business =="Sms"){
        b = OC_12
      }else if(a$package_price >20000 & a$package_price <=50000 & a$category_business =="Bonus/promotion"){
        b = OC_50
      }else if(a$package_price >50000 & a$package_price <=75000 & a$category_business =="Validity + quota"){
        b = OC_13
      }else if(a$package_price >50000 & a$package_price <=75000 & a$category_business =="Roaming"){
        b = OC_14
      }else if(a$package_price >50000 & a$package_price <=75000 & a$category_business =="VAS"){
        b = OC_15
      }else if(a$package_price >50000 & a$package_price <=75000 & a$category_business =="Unlimited"){
        b = OC_16
      }else if(a$package_price >50000 & a$package_price <=75000 & a$category_business =="Voice"){
        b = OC_17
      }else if(a$package_price >50000 & a$package_price <=75000 & a$category_business =="Sms"){
        b = OC_18
      }else if(a$package_price >50000 & a$package_price <=75000 & a$category_business =="Bonus/promotion"){
        b = OC_51
      }else if(a$package_price >75000 & a$package_price <=100000 & a$category_business =="Validity + quota"){
        b = OC_19
      }else if(a$package_price >75000 & a$package_price <=100000 & a$category_business =="Roaming"){
        b = OC_20
      }else if(a$package_price >75000 & a$package_price <=100000 & a$category_business =="VAS"){
        b = OC_21
      }else if(a$package_price >75000 & a$package_price <=100000 & a$category_business =="Unlimited"){
        b = OC_22
      }else if(a$package_price >75000 & a$package_price <=100000 & a$category_business =="Voice"){
        b = OC_23
      }else if(a$package_price >75000 & a$package_price <=100000 & a$category_business =="Sms"){
        b = OC_24
      }else if(a$package_price >75000 & a$package_price <=100000 & a$category_business =="Bonus/promotion"){
        b = OC_52
      }else if(a$package_price >100000 & a$package_price <=150000 & a$category_business =="Validity + quota"){
        b = OC_25
      }else if(a$package_price >100000 & a$package_price <=150000 & a$category_business =="Roaming"){
        b = OC_26
      }else if(a$package_price >100000 & a$package_price <=150000 & a$category_business =="VAS"){
        b = OC_27
      }else if(a$package_price >100000 & a$package_price <=150000 & a$category_business =="Unlimited"){
        b = OC_28
      }else if(a$package_price >100000 & a$package_price <=150000 & a$category_business =="Voice"){
        b = OC_29
      }else if(a$package_price >100000 & a$package_price <=150000 & a$category_business =="Sms"){
        b = OC_30
      }else if(a$package_price >100000 & a$package_price <=150000 & a$category_business =="Bonus/promotion"){
        b = OC_53
      }else if(a$package_price >150000 & a$package_price <=200000 & a$category_business =="Validity + quota"){
        b = OC_31
      }else if(a$package_price >150000 & a$package_price <=200000 & a$category_business =="Roaming"){
        b = OC_32
      }else if(a$package_price >150000 & a$package_price <=200000 & a$category_business =="VAS"){
        b = OC_33
      }else if(a$package_price >150000 & a$package_price <=200000 & a$category_business =="Unlimited"){
        b = OC_34
      }else if(a$package_price >150000 & a$package_price <=200000 & a$category_business =="Voice"){
        b = OC_35
      }else if(a$package_price >150000 & a$package_price <=200000 & a$category_business =="Sms"){
        b = OC_36
      }else if(a$package_price >150000 & a$package_price <=200000 & a$category_business =="Bonus/promotion"){
        b = OC_54
      }else if(a$package_price >200000 & a$package_price <=400000 & a$category_business =="Validity + quota"){
        b = OC_37
      }else if(a$package_price >200000 & a$package_price <=400000 & a$category_business =="Roaming"){
        b = OC_38
      }else if(a$package_price >200000 & a$package_price <=400000 & a$category_business =="VAS"){
        b = OC_39
      }else if(a$package_price >200000 & a$package_price <=400000 & a$category_business =="Unlimited"){
        b = OC_40
      }else if(a$package_price >200000 & a$package_price <=400000 & a$category_business =="Voice"){
        b = OC_41
      }else if(a$package_price >200000 & a$package_price <=400000 & a$category_business =="Sms"){
        b = OC_42
      }else if(a$package_price >200000 & a$package_price <=400000 & a$category_business =="Bonus/promotion"){
        b = OC_55
      }else if(a$package_price >400000 & a$category_business =="Validity + quota"){
        b = OC_43
      }else if(a$package_price >400000 & a$category_business =="Roaming"){
        b = OC_44
      }else if(a$package_price >400000 & a$category_business =="VAS"){
        b = OC_45
      }else if(a$package_price >400000 & a$category_business =="Unlimited"){
        b = OC_46
      }else if(a$package_price >400000 & a$category_business =="Voice"){
        b = OC_47
      }else if(a$package_price >400000 & a$category_business =="Sms"){
        b = OC_48
      }else if(a$package_price >400000 & a$category_business =="Bonus/promotion"){
        b = OC_56
      }
      #print(b)
      if(#dim(b)[1]==0 #using dimension
        length(b[,1])==0){#using length
        return("There are No Similiar Competitor Package")
      }else{
        total_poin = 0;
        for(i in 1: length(b[,1])){
          ...
          if(a$package_price <= b[i,]$Package.Price){
            temp_poin = temp_poin+1
          }
          else{
            temp_poin = temp_poin+0
          }
          if(a$package_validity >= b[i,]$Package.Validity){
            temp_poin = temp_poin+1
          }
          if(a$vas=="Yes"){
            temp_poin = temp_poin +1
          }else if(a$vas=="No" & b[i,]$Value.added.Service.VAS..=="No"){
            temp_poin = temp_poin +1
          }
          if(a$SOP == b[i,]$SOP){
            temp_poin = temp_poin +1
            ...
            temp_poin = temp_poin +1
          }else if(a$SOP == 3 & b[i,]$SOP ==2){
            temp_poin = temp_poin +1
          }else if(a$SOP == 2 & b[i,]$SOP ==1){
            temp_poin = temp_poin +1
          }else if(a$SOP == 3 & b[i,]$SOP ==1){
            temp_poin = temp_poin +1
          }else if(a$SOP != b[i,]$SOP & b[i,]$SOP !=6){
            temp_poin = temp_poin +1
          }
          if(temp_poin > 2){
